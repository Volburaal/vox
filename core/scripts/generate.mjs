...
const javaAvailable = spawnSync('java', ['-version'], { stdio: 'ignore', shell: true }).status === 0;

if (!javaAvailable) {
  if (existsSync(parserFile)) {
    console.warn('generate: Java not found; reusing the existing parser in core/src/gen');
    process.exit(0);
  }
  console.error(`
